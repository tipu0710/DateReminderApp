                    ...
                    editTv.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            *//*
                            ...
                            txtDateD.setText(finalPerson.getLoanDate());
                            txtTimeD.setText(txtTime.getText());
                            txtPhoneNoD.setText(finalPerson.getPhoneNo());
                            txtAmountD.setVisibility(View.VISIBLE);
                            txtAmountD.setText(finalPerson.getAmountLoan().toString());

                            if (status){
                                txtTime.setVisibility(View.GONE);
                            }else {
                                txtTime.setVisibility(View.VISIBLE);
                                int[] time = SetAlarm.formatTime(finalPerson.getTimeLoner());
                                if (time[2]==0){
                                    txtTime.setText(time[0]+":"+time[1]+"PM");
                                }else {
                                    txtTime.setText(time[0]+":"+time[1]+"AM");
                                }
                            }
                            ...
                            fabAddPersonD.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    if (name.isEmpty()){
                                        ...
                                        finalPerson.setLoanDate(date);
                                        finalPerson.setTimeLoner(finalHour[0]+":"+finalMinute[0]);
                                        finalPerson.setPhoneNo(phone);
                                        finalPerson.setAmountLoan(Double.parseDouble(amount));
